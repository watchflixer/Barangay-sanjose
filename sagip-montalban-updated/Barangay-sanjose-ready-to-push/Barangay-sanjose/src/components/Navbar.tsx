      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6">
        <div className="flex items-center justify-between h-16 gap-2 sm:gap-4">
          ...
          <div className="flex items-center space-x-2 shrink-0">
            <div className="flex h-8 items-center justify-center mr-4 sm:mr-5 text-slate-800 font-sans font-semibold text-xs tracking-tight tabular-nums whitespace-nowrap">
              {currentTime || 'PST'}
            </div>
