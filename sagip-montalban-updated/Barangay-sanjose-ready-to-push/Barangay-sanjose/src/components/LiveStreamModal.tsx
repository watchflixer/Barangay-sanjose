...
export const LiveStreamModal: React.FC<LiveStreamModalProps> = ({
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Please enter a valid URL (e.g. https://www.facebook.com/... or https://youtube.com/...)');
    }
  };
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full overflow-hidden border border-slate-200 animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="px-5 py-4 bg-slate-900 text-white flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-sm font-bold tracking-tight">Link Facebook Live Stream</h2>
              <p className="text-[11px] text-slate-300">LIVE | Water Level Monitoring of the Municipality of Montalban</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSave} className="p-5 space-y-4">
          <div className="space-y-1.5">
            ...
            <p className="text-[11px] text-slate-500 leading-relaxed">
              Paste the direct link of the live broadcast of the <strong>Municipality of Montalban</strong> or MDRRMO here. Once a link is set, the official video player automatically appears above the incident status.
            </p>
          </div>
          ...
          <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 text-xs text-slate-600 space-y-1.5">
            <div className="font-semibold text-slate-700 flex items-center gap-1.5">
              ...
              <span>How to get the Facebook link:</span>
            </div>
            <p className="text-[11px] text-slate-500">
              1. Open the Live post on Facebook.<br />
              2. Click <strong>Share</strong> or <strong>Copy Link</strong>.<br />
              3. Paste the link in the box above and click <strong>Save & Embed</strong>.
            </p>
          </div>
